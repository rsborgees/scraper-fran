...
async function sendSpecificItems(limit = 25) {
    ...
    try {
        ...
        // 4. Limite solicitado (Aumentado para garantir 25 sucessos)
        const targetItems = candidates.slice(0, 35);
        console.log(`🎯 Selecionados ${targetItems.length} candidatos para tentar chegar em 25 sucessos.`);
        ...
        try {
            ...
            if (results.length > 0) {
                // Slice para exatamente 25 se tiver mais
