...
async function parseProduct(url) {
    ...
    try {
        ...
        const result = await page.evaluate(() => {
            ...
            // Agora usando o utilitário centralizado se disponível (ou replicando a lógica se estiver no evaluate)
            ...
            if (clothingCategoriesList.includes(category)) {
                const uniqueSizesNormalized = uniqueSizes.map(s => s.toUpperCase());
